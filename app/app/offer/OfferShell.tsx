    ...
    <div className="min-h-screen bg-background px-4 py-8 sm:py-12">
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          <a href="/" className="text-lg font-bold text-charcoal tracking-tight hover:text-gold transition-colors">
            MCar
          </a>
        </div>
        ...
        {/* Trust badges */}
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[10px] text-warm-gray uppercase tracking-wider">
